...
$currentPageResults = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
$endPage = min($totalDatabasePages, $page + $visibleRange);
...
// Link to last page
if ($page < $currentPageResults) {
  echo '<a href="?page=' . $totalDatabasePages . '">&raquo;</a>';
} else {
