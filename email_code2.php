...
if(isset($_POST["confirm"])) {
    ...
    if(isset($_GET['register_email'])) {
        ...
        echo "<div class='warning'>Registered email not found.</div>";
    }
}
...
if(isset($_POST["resend"])) {
    ...
    if($stmt->execute()) {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'doffy.dualpass12@gmail.com'; // SMTP username
            $mail->Password   = 'qekn szpe wxsx ttzz';            // SMTP password
            $mail->SMTPSecure = 'tls';
            $mail->Port       = 587;
